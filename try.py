{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNeULcGlwRyF+0h7lB0av5q",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "collapsed": true,
        "id": "brOJefECFz9k",
        "outputId": "11461eb7-6688-4791-df7f-484e9a32eae6"
      },
      "execution_count": 4,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "# User Input\n",
        "expression = st.text_input(\"Enter your expression (e.g., 2+3*sqrt(4))\")\n",
        "\n",
        "# Scientific Operations\n",
        "st.write(\"Scientific Functions Available:\")\n",
        "st.write(\"- sqrt(x): Square root\")\n",
        "st.write(\"- log(x): Natural logarithm\")\n",
        "st.write(\"- log10(x): Base 10 logarithm\")\n",
        "st.write(\"- exp(x): Exponential (e^x)\")\n",
        "st.write(\"- sin(x), cos(x), tan(x): Trigonometric functions (angle in radians)\")\n",
        "st.write(\"- asin(x), acos(x), atan(x): Inverse Trigonometric functions (output in radians)\")\n",
        "\n",
        "# Evaluate the Expression\n",
        "def calculate_expression(expr):\n",
        "    \"\"\"Evaluate the expression entered by the user.\"\"\"\n",
        "    try:\n",
        "        # Use eval safely by restricting it to numpy and math functions\n",
        "        allowed_funcs = {\n",
